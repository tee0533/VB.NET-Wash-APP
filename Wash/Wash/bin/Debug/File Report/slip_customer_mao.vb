...
Public Class slip_customer_mao
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Wash.slip_customer_mao.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedslip_customer_mao
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As slip_customer_mao = New slip_customer_mao()
        rpt.Site = Me.Site
        Return rpt
    End Function
